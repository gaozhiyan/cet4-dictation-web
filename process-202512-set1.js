...
const srtPath = '/Users/gao/Desktop/others/CET4/听力练习/2024四级真题及解析_for 艾薇/202512-set1/202512-set1.srt';
const audioPath = '/Users/gao/Desktop/others/CET4/听力练习/2024四级真题及解析_for 艾薇/202512-set1/202512-set1.mp3';
const outAudioDir = path.join(__dirname, 'public/audio');
const outJsonPath = path.join(__dirname, 'public/data/202512-set1.json');
const baseName = '202512-set1';
const sourceName = '202512 第一套';
