            ...
            <div className="grid lg:grid-cols-2 gap-8 items-start pb-20">
                ...
                <DuoCard className="hover:-translate-y-1 hover:shadow-lg transition-all duration-200 border-[#1cb0f6] border-b-4">
                  <div className="flex flex-col h-full">
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <div className="flex items-center gap-2 mb-1">
                            <h2 className="text-2xl font-extrabold text-slate-700">通用听力实战</h2>
                    ...
                    <div className="bg-[#1cb0f6]/5 p-4 rounded-2xl border-2 border-[#1cb0f6]/20 mb-4">
                      <p className="text-[#1cb0f6] font-bold text-sm">🎧 <b>全真语境</b>：包含校园生活、求职面试、学术讲座等通用听力材料，核心测试四级通用词汇。</p>
                    </div>
                  ...
                  <div className="flex flex-col h-full">
                    <div className="flex items-center gap-4 mb-4">
                      ...
                      <div>
                        ...
                        <p className="text-slate-400 font-bold text-sm">褪去语境包装，直击过去两年考场原题</p>
                      </div>
                    </div>
              ...
              <div className="space-y-10">
                ...
                <div className="space-y-6">
                  ...
                  <DuoCard className="cursor-pointer hover:-translate-y-1 hover:shadow-lg active:translate-y-0 active:shadow-sm transition-all duration-200 border-[#58cc02] border-b-4" onClick={() => router.push(`/chat`)}>
                    <div className="flex flex-col h-full">
                      <div className="flex items-center gap-4 mb-4">
                        ...
                        <div>
                          ...
                          <p className="text-slate-400 font-bold mt-1 text-sm">在日常和通用对话中练习四级词汇输出</p>
                        </div>
                      </div>
...
start_str = "              {/* 职业方向选择器 (Global Dashboard) */}"
end_str = "                {/* 数据探索与工具 */}"
