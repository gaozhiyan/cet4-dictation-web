...
if 'const [isReviewSession, setIsReviewSession] = useState(false)' in content and 'showListeningModal' not in content:
              ...
              <div className="space-y-4">
                ...
                <DuoCard className="cursor-pointer hover:border-purple-400 transition-colors !p-4 flex items-center gap-4" onClick={() => { setShowListeningModal(false); router.push('/exam'); }}>
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs font-bold text-slate-400">历届真题原音重现</p>
                  </div>
                  <ChevronRight className="w-5 h-5 text-slate-300" />
                </DuoCard>
              </div>
